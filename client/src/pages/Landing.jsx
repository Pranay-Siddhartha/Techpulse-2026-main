...
function FloatingParticle({ delay, left, size, color }) {
    return (
        <div
            ...
            style={{
                ...
                animation: `float-up ${8 + Math.random() * 6}s ${delay}s linear infinite`,
            }}
        />
    );
}
...
export default function Landing() {
    ...
    return (
        <motion.div {...pageTransition} className="relative min-h-screen flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 text-center px-6 max-w-4xl mx-auto w-full">
                ...
                <motion.p
                    ...
                    className="font-heading text-xs tracking-[0.3em] uppercase text-neon-blue/70 mb-6"
                >
                    CODEHUB PRESENTS
                </motion.p>
                ...
                <motion.h1
                    ...
                    className="glitch font-heading text-6xl md:text-8xl font-black mb-6 leading-tight"
                ...
                >
                    <Link to="/register" className="neon-btn !bg-gradient-to-r !from-neon-purple/30 !to-neon-blue/20 !border-neon-purple">
                        <span className="relative z-10">⚡ Register Now</span>
                    </Link>
                    <Link to="/events" className="neon-btn !border-neon-blue/50">
                        <span className="relative z-10">🔮 View Events</span>
                    </Link>
                    <Link to="/schedule" className="neon-btn !border-white/20 !bg-white/5">
